        ...
        <NavLeft >
           ...
           <Link to='/' style={{textDecoration:'none',color:'black'}}>
                <Box sx={{display:{xs:'none',sm:'none',md:'block'},cursor:'pointer',textDecoration:'none'}} >
                   <Typography sx={{fontSize:'40px',fontWeight:'700',color:'black',textDecoration:'none'}}>Big Mall</Typography>   
                </Box>
           </Link>
                {/* <SearchBar/> */}
        ...
        <Box sx={{width:{xs:'300px',sm:'500px'},height:{xs:'120px',sm:'180px'},border:'1px solid rgba(0,0,0,0.2)',borderRadius:'20px'}}>
            <Box sx={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                <Box sx={{display:'flex',flexDirection:'column',margin:'10px',justifyContent:'center'}}>
                    <Typography sx={{fontSize:'30px',fontWeight:'700'}}>Big mall</Typography>
                    <Typography> Your required  products</Typography>
                    <Typography sx={{fontSize:'17px',fontWeight:'600'}}>View All</Typography>
                </Box>
                <Box sx={{margin:'10px'}}>
                   <img src='https://img.lovepik.com/free-png/20220126/lovepik-medicine-cabinet-and-medicine-png-image_401806165_wh300.png' style={{height:'100px',width:'100px',borderRadius:'10px'}}/>
                </Box>
            </Box>
