...
import { getCordinate } from '../Location/Location';
        ...
        <NavLeft >
           ...
           <Link to='/' style={{textDecoration:'none',color:'black'}}>
                <Box sx={{display:{xs:'none',sm:'none',md:'block'},cursor:'pointer',textDecoration:'none'}} >
                   <Typography sx={{fontSize:'40px',fontWeight:'700',color:'black',textDecoration:'none'}}>Grocery Shop</Typography>   
                </Box>
           </Link>
                {/* <SearchBar/> */}
        ...
        <Box sx={{width:{xs:'300px',sm:'500px'},height:{xs:'120px',sm:'180px'},border:'1px solid rgba(0,0,0,0.2)',borderRadius:'20px'}}>
            <Box sx={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                <Box sx={{display:'flex',flexDirection:'column',margin:'10px',justifyContent:'center'}}>
                    <Typography sx={{fontSize:'30px',fontWeight:'700'}}>Groceries</Typography>
                    <Typography>Enjoy your favourite groceries</Typography>
                    <Typography sx={{fontSize:'17px',fontWeight:'600'}}>View All</Typography>
                </Box>
                <Box sx={{margin:'10px'}}>
                   <img src='https://images.pexels.com/photos/1666067/pexels-photo-1666067.jpeg?auto=compress&cs=tinysrgb&w=600' style={{height:'100px',width:'100px',borderRadius:'10px'}}/>
                </Box>
            </Box>
