    ...
    <>
        ...
        <NavBar2>
            <Box sx={{width:'100%',display:'flex',justifyContent:{xs:'space-between',sm:'space-between'},alignItems:'center',padding:{ xs:'0px 40px 0px 15px',sm:'0px 60px',md:'0px 120px',lg:'0px 160px',xl:'0px 200px'}}}>
                <Box>
                    <img style={{height:'60px' , width:'100px',cursor:'pointer'}} src='https://img.freepik.com/premium-photo/eco-friendly-golden-house-3d-real-estate-rendering_585146-138.jpg?size=626&ext=jpg' alt='card' />
                </Box>
