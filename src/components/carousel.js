...
const  Mycarousel = () => {
  ...
  return (
    <Carousel data-aos="fade-up" data-aos-duration="1000" style={{ position: "relative",height:"600px", "@media (max-width: 800px)": {
      position:"absolute",
      marginTop:"100px" ,  
      height:"800px"
 ...
 <div  data-aos="fade-right" data-aos-duration="2000" style={{
      width: '100%',
      height: '600px',
      backgroundImage: 'url(https://images.unsplash.com/uploads/141148589884100082977/a816dbd7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80)',
    ...
    <div data-aos="fade-left" data-aos-duration="3000" style={{
      width: '100%',
      height: '600px',
      backgroundImage: 'url(https://images.unsplash.com/photo-1515899199927-d4cf9e8cef30?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1033&q=80)',
      backgroundRepeat: 'no-repeat',
      backgroundSize: 'cover',
      display: 'flex',
      flexDirection: 'row',
    ...
    <div data-aos="fade-left" data-aos-duration="3000" style={{
      width: '100%',
      height: '600px',
      backgroundImage: 'url(https://plus.unsplash.com/premium_photo-1669748158379-b1460474807c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80)',
      backgroundRepeat: 'no-repeat',
      backgroundSize: 'cover',
      display: 'flex',
      flexDirection: 'row',
