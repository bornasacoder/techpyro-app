          ...
          <Grid item xs={12} sm={4} md={4} data-aos="zoom-in">
            <Item
              sx={{
                ...
                color: "white",
                fontWeight: "600",
                background: `url(${"https://img.freepik.com/free-psd/fashion-jewelry-web-template-with-photo_23-2149054941.jpg?size=626&ext=jpg&ga=GA1.1.2042454013.1682690444&semt=ais"})
          ...
          <Grid item xs={12} sm={4} md={4} data-aos="zoom-in">
            <Item
              sx={{
                ...
                color: "white",
                fontWeight: "600",
                background: `url(${"https://img.freepik.com/free-psd/fashion-design-facebook-ad-template_23-2149545219.jpg?size=626&ext=jpg&ga=GA1.1.2042454013.1682690444&semt=ais"})
   center/cover no-repeat`,
                height: "200px",
                // width:'350px'
              }}
