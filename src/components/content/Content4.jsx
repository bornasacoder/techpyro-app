...
const StyleToolbar = styled(Box)(({ theme }) => ({
  ...
  background: `url(${"https://img.freepik.com/premium-photo/yellow-couch-with-green-wall-leaf-it_812649-692.jpg?size=626&ext=jpg"})
    ...
    <StyleToolbar>
      <Box  sx={{width:{md:"50%",sm:'100%',sx:"100%"},marginTop:"30px"}}>
        ...
        <Typography
          ...
          data-aos="fade-left" >
          A furniture with advanced features ,
          <br />
