...
const StyleToolbar = styled(Box)(({ theme }) => ({
  ...
  background: `url(${"https://img.freepik.com/free-vector/talk-show-shooting-tv-studio-isometric-illustration_1284-27146.jpg?size=626&ext=jpg"})
    ...
    <StyleToolbar>
      <Box  sx={{width:{md:"50%",sm:'100%',sx:"100%"},marginTop:"30px"}}>
        ...
        <Typography
          ...
          data-aos="fade-left" >
          A studio with advanced features ,
          <br />
