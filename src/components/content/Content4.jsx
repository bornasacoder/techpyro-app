...
const StyleToolbar = styled(Box)(({ theme }) => ({
  ...
  background: `url(${"https://img.freepik.com/premium-photo/cpu-central-computer-processors-with-circuit-board-concept-ai-mobile-processor_73903-1090.jpg?size=626&ext=jpg"})
