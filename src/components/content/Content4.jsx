...
const StyleToolbar = styled(Box)(({ theme }) => ({
  ...
  background: `url(${"https://img.freepik.com/free-photo/pair-gold-earrings-with-green-stones-black-background_1340-42887.jpg?size=626&ext=jpg"})
    ...
    <StyleToolbar>
      <Box  sx={{width:{md:"50%",sm:'100%',sx:"100%"},marginTop:"30px"}}>
        ...
        <Typography
          ...
          data-aos="fade-left" >
          A jwellery with advanced features ,
          <br />
