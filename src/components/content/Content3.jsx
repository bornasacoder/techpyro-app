...
export default function Content3() {
  ...
  ),url(${"https://img.freepik.com/free-psd/best-friends-forever-landing-page-template_23-2148696493.jpg?size=626&ext=jpg&ga=GA1.1.2042454013.1682690444&semt=ais"})
        ...
        >
          <Grid item xs={12} sm={12} md={12}>
            <Item
              sx={{
                background: `linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0)
  ),url(${"https://img.freepik.com/free-psd/flat-design-sale-template_23-2149834861.jpg?size=626&ext=jpg&ga=GA1.1.2042454013.1682690444&semt=ais"})
   center/cover no-repeat`,
                height: "300px",
              }}
            >
