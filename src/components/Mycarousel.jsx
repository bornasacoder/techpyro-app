...
const  Mycarousel = () => {
 ...
 <div  data-aos="fade-right" data-aos-duration="2000" style={{
      width: '100%',
      height: '600px',
      backgroundImage: 'url(https://images.pexels.com/photos/683039/pexels-photo-683039.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
      display: 'flex',
      flexDirection: 'row',
      alignItems: 'center',
    ...
    <div data-aos="fade-left" data-aos-duration="3000" style={{
      width: '100%',
      height: '600px',
      backgroundImage: 'url(https://images.pexels.com/photos/2067431/pexels-photo-2067431.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
      display: 'flex',
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center'
    ...
    <div data-aos="fade-left" data-aos-duration="3000" style={{
      width: '100%',
      height: '600px',
      backgroundImage: 'url(https://images.pexels.com/photos/3465604/pexels-photo-3465604.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
      display: 'flex',
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center'
