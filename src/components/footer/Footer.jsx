  ...
  return (
    <Box>
        ...
        >
          ...
          >
            <Grid item xs={12} sm={6} md={4}>
              ...
              <br />
              <Typography>
                Sed suscipit mauris nec mauris vulputate, a posuere libero
                congue. Nam laoreet elit eu erat pulvinar, et efficitur nibh
                euismod. Proin venenatis orci sit amet nisl finibus vehicula.
              </Typography>
              <br />
              <Typography>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              <br />
              <br />
              <Typography color="red">BAKED SPAGHETTI</Typography>
              <br />
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              <Typography>New York, NY 666555</Typography>
              <Typography>Phone: +1-315-277-3623</Typography>
              <Typography>
      ...
      >
        ...
        <Typography fontSize="24px"  fontWeight="200"> |</Typography>
        <Typography >
