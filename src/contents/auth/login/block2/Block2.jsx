    ...
    <>
        ...
        <Box sx={{display:`block`}}>
          ...
          {errors.password && touched.password ? (
            ...
            <Button sx={{marginTop:'5px',width:'100%', ":disabled":{background:`${theme.colors.alpha.black[10]}`},boxShadow:'0 2px 4px 0 rgb(0 0 0/ 15%)'}} variant='contained' disabled={`${count}`==='10'&&(`${length}`>='6' )?false:true} onSubmit={handleSubmit}>Continue</Button>
            <Link to={'#'} style={{textDecoration:'none',}}>Forget password?</Link>
            </form>
            <Button type='text' onClick={handleMobileANDotpPage} sx={{width:'100%',margin:'20px 0',borderRadius:'4px',fontSize:'15px',color:`${theme.colors.success.dark}`,cursor:{md:'pointer',xs:'none'},boxShadow:'0 2px 4px 0 rgb(0 0 0/ 20%)'}}>Login Phone and OTP</Button>
