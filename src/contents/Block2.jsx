...
const Block2 = () => {
  ...
  const Box2= styled(Box)(({ theme }) => ({
    height:'680px',
    width:'100%',
    backgroundImage: `url(${"https://images.pexels.com/photos/147637/pexels-photo-147637.jpeg?auto=compress&cs=tinysrgb&w=600"})`,
    backgroundSize:'cover',
    backgroundAttachment:'fixed',
    display:'flex',
     ...
     <Box1>
      ...
      <CardBox >
       ...
       <Box sx={{height:{xs:'100%',sm:'50%',md:'auto'},width:{xs:'100%',sm:'100%',md:'50%'},display:'flex',flexDirection:'column',background:'#F6F7FB',justifyContent:'center',alignItems:'center'}}>
        <Typography sx={{fontSize:{xs:'35px',sm:'30px',md:'30px'},fontWeight:'700'}}>About Our Jewelleries</Typography>
      ...
      <CardBox >
        ...
        sx={{height:'100%'}}
          component="img"
          image="https://images.pexels.com/photos/2100868/pexels-photo-2100868.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="green iguana"
        />
     </Box>
     <Box sx={{height:{xs:'100%',sm:'50%',md:'auto'},width:{xs:'100%',sm:'100%',md:'50%'},display:'flex',flexDirection:'column',background:'#F6F7FB',justifyContent:'center',alignItems:'center'}}>
