...
const Block2 = () => {
  ...
  const Box1= styled(Box)(({ theme }) => ({
    height:'600px',
    width:'100%',
    backgroundImage: `url(${"https://images.pexels.com/photos/2954405/pexels-photo-2954405.jpeg?auto=compress&cs=tinysrgb&w=600"})`,
  ...
  const Box2= styled(Box)(({ theme }) => ({
    height:'680px',
    width:'100%',
    backgroundImage: `url(${"https://images.pexels.com/photos/1021235/pexels-photo-1021235.jpeg?auto=compress&cs=tinysrgb&w=600"})`,
    backgroundSize:'cover',
    // backgroundAttachment:'fixed',
    display:'flex',
     ...
     {/* <Box1>
      ...
      <CardBox >
       ...
       <Box sx={{height:{xs:'100%',sm:'50%',md:'auto'},width:{xs:'100%',sm:'100%',md:'50%'},display:'flex',flexDirection:'column',background:'#F6F7FB',justifyContent:'center',alignItems:'center',paddingLeft:'20px'}}>
        <Box>
        <Typography sx={{fontSize:{xs:'35px',sm:'30px',md:'30px'},fontWeight:'700'}}>About Our Products</Typography>
      ...
      <Button variant='contained' sx={{borderRadius:'0',marginTop:'30px'}}>VIEW FULL LISTS</Button>
       ...
       <Typography sx={{fontSize:{xs:'40px',sm:'30px',md:'40px'}}}>What kind of Product we show for you</Typography>
       ...
       <Typography sx={{fontSize:{xs:'30px',sm:'30px',md:'35px'},fontWeight:'700'}}>Product and Customer Gallery</Typography>
