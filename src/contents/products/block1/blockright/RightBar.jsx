...
import {Box, Checkbox, Drawer, styled, Typography,Zoom } from '@mui/material'
...
import { cartListProduct, createCart, updateCartProduct } from '../../../../redux/apiCalls'
...
const RightBar = () => {
  ...
  const handleCartButton = async ()=>{
    let item = {
      "productId": "63edf99c3d3ffda367ca8975",
      "qty": 1,
      "packageId":"63ecc5822e1797f4b8ff43b1"
    }
  ...
  return (
    <RightContainer>
      <RightItems>
        <Typography sx={{ display: "flex", justifyContent: "center", alignItems: "center", color: "#878787", fontWeight: "400", fontSize: "12px",  }}>Home <NavigateNext /> Education <NavigateNext />  Coachings</Typography>
      </RightItems>
      <RightItems>
...
{/* filtering of the templates */}
     ...
     <Buttons onClick={handleCartButton} variant="outlined">
