  ...
  return (
    ...
    <div>
        <div className='flex md:flex-col flex-row md:justify-evenly justify-between md:mb-0 mb-2'>
            ...
            <div><FacebookOutlinedIcon /><span className='md:block hidden'>Facebook</span></div> 
            <div><TwitterIcon /><span className='md:block hidden'>Twitter</span></div>
            <div><YouTubeIcon /><span className='md:block hidden'>Youtube</span></div>
            <div><InstagramIcon /><span className='md:block hidden' >Instagram</span></div>
        </div>
        </div>
