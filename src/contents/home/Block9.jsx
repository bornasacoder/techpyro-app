...
<Box sx={{backgroundColor:'#F2F2F2',display:'flex',flexDirection:'column',alignItems:'center',width:{xs:'100%',sm:'100%',md:'530px'},boxShadow:'1px 2px 5px 1px rgba(0,0,0,0.1)',borderRadius:'20px'}}>
  <Typography sx={{backgroundColor:'#616DFF',color:'white',fontSize:'20px',fontWeight:'600',width:'150px',display:'flex',justifyContent:'center',borderRadius:'10px'}}>Class 9-10</Typography>
...
<Box sx={{backgroundColor:'#F2F2F2',display:'flex',flexDirection:'column',alignItems:'center',width:{xs:'100%',sm:'100%',md:'530px'},boxShadow:'1px 2px 5px 1px rgba(0,0,0,0.1)',borderRadius:'20px'}}>
  <Typography sx={{backgroundColor:'#616DFF',color:'white',fontSize:'20px',fontWeight:'600',width:'150px',display:'flex',justifyContent:'center',borderRadius:'10px'}}>Class 11-12</Typography>
