...
padding:'50px 0px'
  ...
  return ( 
    <>
       ...
       <Box sx={{textAlign:'center',marginTop:'80px',color:'#0D2D62'}}>
       <Typography sx={{fontSize:{xs:'30px',sm:'30px',md:'40px'},fontWeight:'700',fontFamily:'Butler'}}>Testimonials </Typography>
    ...
    <Box  data-aos-duration="3000" sx={{display:'flex',justifyContent:'center',flexDirection:{xs:'column',sm:'column',md:'row'},margin:{xs:'0px',sm:'0px 50px',md:'80px 0px'},gap:'20px'}}>
      ...
      <CardBox >
      <Box sx={{height:{xs:'100%',sm:'100%',md:'100%'},width:{xs:'100%',sm:'100%',md:'50%'},display:{xs:'flex',sm:'flex',md:'flex'},justifyContent:'center',alignItems:'center'}}>
        <CardMedia
      ...
      <Box sx={{height:{xs:'auto',sm:'auto',md:'auto'},width:{xs:'100%',sm:'100%',md:'50%'},display:'flex',justifyContent:'center',gap:'10px',padding:'0px'}}>
