    ...
    <Box sx={{margin:'30px 0px',background:'#fff',padding:{md:'30px', sm:'20px',xs:'5px'}}}>
        <Box sx={{display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center',}}>
            ...
            <Box sx={{padding:'15px',opacity:'0.7'}}>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}>We’re a Car operator in the industry, meanwhile, we are independent Cars like you too. We deeply know and care about your concerns regarding Car</Typography>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}> abroad as there still some uncertainty outside the world. To provide you with updated news and professional advice, our Car specialists monitor and collect first-</Typography>
            ...
            <Card sx={{width:{xs:'100%',sm:'600px',md:'700px',lg:'920px'},marginTop:'30px'}}>
              ...
              <Box sx={{display:'flex',flexDirection:'column',alignItems:'center',padding:'7px'}}>
                ...
                <Typography sx={{fontSize:{md:'18px',xs:'16px'}}}>Thanks Make Journey team to make my beauty very cost effectively</Typography>
                <Typography sx={{color:'#FC6E74',marginTop:'20px',fontSize:{md:'18px',xs:'16px'}}}>Derrik</Typography>
                <Typography sx={{fontSize:{md:'18px',xs:'16px'}}}>experience  Taxi Driver </Typography>
              </Box >
