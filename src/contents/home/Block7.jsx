    ...
    <Box sx={{margin:'30px 0px',background:'#fff',padding:{md:'30px', sm:'20px',xs:'5px'}}}>
        <Box sx={{display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center',}}>
            ...
            <Box sx={{padding:'15px',opacity:'0.7'}}>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}>We’re a Stdio operator in the industry, meanwhile, we are independent Stdios like you too. We deeply know and care about your concerns regarding Stdio</Typography>
