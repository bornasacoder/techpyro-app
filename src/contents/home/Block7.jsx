    ...
    <Box sx={{margin:'30px 0px',background:'#fff',padding:{md:'30px', sm:'20px',xs:'5px'}}}>
        <Box sx={{display:'flex', flexDirection:'column',justifyContent:'center',alignItems:'center',}}>
            ...
            <Box sx={{padding:'15px',opacity:'0.7'}}>
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}>We’re a Hotel operator in the industry, meanwhile, we are independent Hotel like you too. We deeply know and care about your concerns regarding Hotel</Typography>
                ...
                <Typography sx={{fontSize:{md:'20px',xs:'16px'}}}> promise your Hotel will be in safe hands.</Typography>
            </Box>
            ...
            <Card sx={{width:{xs:'100%',sm:'600px',md:'700px',lg:'920px'},marginTop:'30px'}}>
              ...
              <Box sx={{display:'flex',flexDirection:'column',alignItems:'center',padding:'7px'}}>
                ...
                <Typography sx={{fontSize:{md:'18px',xs:'16px'}}}>Hotel receiptionist </Typography>
              </Box >
