    ...
    return (
        ...
        <CardBox >
          ...
          <Box sx={{  display:'flex',flex:'1',flexDirection:'column',gap:'15px',justifyContent:'center',paddingLeft:'20px',alignItems:{xs:'flex-start'}}}>
            ...
            <Typography sx={{color:'rgba(0,0,0,0.6)',fontSize:'32px',fontWeight:'600'}}>Creating memories, forever</Typography>
            <Typography sx={{color:'#C4CBD6',fontSize:'20px',fontWeight:'600'}}>Our knowledgeable staff is always on hand to assist customers in finding the perfect piece of jewelry for their needs. Whether you are shopping for an engagement ring or a gift for a loved one, we are here to help make your experience a memorable one.</Typography>
