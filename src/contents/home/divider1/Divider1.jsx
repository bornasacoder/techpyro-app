...
export default function Divider1({image}) {
  ...
  return (
    <Container>
        ...
        <ContainerInner >
            <Typography sx={{textAlign:'center', fontSize:{md:'25px',sm:'20px',xs:'18px'}, fontWeight: 900, color:'#fff' }}>Jewellery Trending</Typography>
