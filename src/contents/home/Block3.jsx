...
const Block2 = () => {
  ...
  const Box3= styled(Box)(({ theme }) => ({
    height:'auto',
    width:'100%',
    backgroundImage: `url(${"https://images.pexels.com/photos/179833/pexels-photo-179833.jpeg?auto=compress&cs=tinysrgb&w=600"})`,
     ...
     <Box  >
      ...
      <Box sx={{height:{xs:'100px',sm:'100px',md:'100px'},width:{xs:'100px',sm:'100px',md:'100px'},paddingTop:{xs:'0px',sm:'0px',md:'0px'},borderRadius:'50px'}}>
        ...
        sx={{height:'100%',borderRadius:'50px'}}
          component="img"
          image="https://images.pexels.com/photos/3738755/pexels-photo-3738755.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="green iguana"
        />
     </Box>
      ...
      <Box sx={{height:{xs:'100px',sm:'100px',md:'100px'},width:{xs:'100px',sm:'100px',md:'100px'},paddingTop:{xs:'0px',sm:'0px',md:'0px'},borderRadius:'50px'}}>
        ...
        sx={{height:'100%',borderRadius:'50px'}}
          component="img"
          image="https://images.pexels.com/photos/2267538/pexels-photo-2267538.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="green iguana"
        />
     </Box>
      ...
      <Box sx={{height:{xs:'100px',sm:'100px',md:'100px'},width:{xs:'100px',sm:'100px',md:'100px'},paddingTop:{xs:'0px',sm:'0px',md:'0px'},borderRadius:'50px'}}>
        ...
        sx={{height:'100%',borderRadius:'50px'}}
          component="img"
          image="https://images.pexels.com/photos/5836769/pexels-photo-5836769.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt="green iguana"
        />
     </Box>
       <Box sx={{height:{xs:'100%',sm:'50%',md:'auto'},width:{xs:'50%',sm:'100%',md:'70%'},display:'flex',flexDirection:{xs:'column',sm:'column',md:'row'},background:'#F6F7FB',justifyContent:'center',alignItems:'center',gap:{xs:'0px',sm:'30px',md:'60px'},backgroundColor:`${theme.header.textColor}`}}>
