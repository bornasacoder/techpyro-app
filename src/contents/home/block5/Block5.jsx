    ...
    return (
        ...
        <CardBox >
          ...
          <Box sx={{ display:'flex',flex:'1',flexDirection:'column',gap:'0px',justifyContent:'center',alignItems:{xs:'center',sm:'center'}}}>
             <Typography  sx={{color:'rgba(0,0,0,0.6)',textAlign:"center",fontSize:{xs:'30px',md:'40px'},fontWeight:{xs:'600'}}}>Experience innovation like never before at our electronic shop</Typography>
         ...
         <Box sx={{height:'100%',display:'flex',flex:'3',gap:'30px',flexDirection:'column',justifyContent:'center',alignItems:{xs:'flex-start',md:'center'}}}>
          ...
          <Typography sx={{color:'#000',fontSize:{xs:'18px',md:'22px',opacity:'0.7'}}}>That's why we work with some of the top brands in the industry to bring you the best products on the market. Whether you're a tech enthusiast or just looking for a reliable device, you can trust our electronic shop to provide you with quality products that meet your needs. So why wait? Visit us today and discover all that we have to offer!</Typography>
