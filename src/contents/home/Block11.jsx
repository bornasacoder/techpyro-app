...
const Block11 = () => {
  ...
  return (
    <>
      <Box1>
      <Typography sx={{fontSize:{xs:'15px',sm:'20px',md:'20px'},fontWeight:'600',color:'#3940E4'}}>Student Information System</Typography>
      <Typography sx={{fontSize:{xs:'15px',sm:'20px',md:'30px'},fontWeight:'600',color:'black'}}>Manage student information,
securely and efficiently</Typography>
